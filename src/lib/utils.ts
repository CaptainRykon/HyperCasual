...
// Utility to merge class names using clsx + tailwind-merge
export function cn(...inputs: ClassValue[]) {
    return twMerge(clsx(inputs));
}

// Generates embed metadata for a Farcaster Frame Mini App
...
// Generates the full Farcaster mini app manifest with optional account association
export async function getFarcasterMetadata(): Promise<MiniAppManifest> {
    // If metadata is set via env, use it
